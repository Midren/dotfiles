...
VOLUME_ICONS=("%{T3}%{T-} " "%{T3}%{T-} " "%{T3}%{T-} " "%{T3}%{T-} " "%{T3}%{T-} " )  # Volume icons array, from lower volume to higher
MUTED_ICON="%{T3}%{T-} "  # Muted volume icon
MUTED_COLOR="%{F#bd2c40}"  # Color when the audio is muted
...
SINK_NICKNAMES["alsa_output.pci-0000_01_00.1.hdmi-stereo"]=" %{T4}🖵%{T-}"
SINK_NICKNAMES["bluez_sink.00_1B_66_AF_9E_FF.a2dp_sink"]=" %{T4}🎧%{T-}"
